...
public class CheckLeftAndRightAlingment 
{
...
//	identify the user name 
		...
		if (usernameStartX == passwordStartX) 
		      {
			      System.out.println("Pass: The Left Alignment of Username and password textfield is found correct and it is verified.");
		      } 
		else 
		   {
			System.out.println("Fail: The Left Alignment of Username and password textfield is found incorrect and it is verified.");
		   }
		if (usernameEndX == passwordEndX) 
		   {
			System.out.println("Pass: The Right Alignment of Username and password textfield is found correct and it is verified.");
		    } 
		else 
		    {
			System.out.println("Fail: The Right Alignment of Username and password textfield is found incorrect and it is verified.");
		     }
